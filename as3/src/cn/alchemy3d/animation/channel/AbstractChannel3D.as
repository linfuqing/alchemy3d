...
{
	import cn.alchemy3d.animation.AnimationKeyFrame3D;
	...
	{	
		 ...
		 * @param	name
		 */ 
		public function AbstractChannel3D(target:Entity, name:String = null)
		{
			this.target = target;
			this.name = name;
		...
		{	
			currentIndex = ((this.keyFrames.length-1) * time) >> 0;
			currentIndex = currentIndex < this.keyFrames.length - 1 ? currentIndex : 0;
			nextIndex = currentIndex + 1;
