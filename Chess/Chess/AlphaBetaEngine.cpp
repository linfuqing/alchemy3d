...
void CAlphaBetaEngine::SearchAGoodMove(BASECHESSBOARD& ChessBoard, const CHESSSIDE Side)
{
...
INT CAlphaBetaEngine::__AlphaBeta(INT nDepth, INT nAlpha, INT nBeta, const CHESSSIDE Side)
{
		BOOL      bIsCurrentSide;
