...
package gs {
	...
	public class OverwriteManager {
		...
		public static function manageOverwrites($tween:TweenLite, $targetTweens:Array):void {
			...
			if (m == AUTO) {
				var tweens:Array = $tween.tweens, v:Object = {}, j:int, t:TweenInfo, overwriteProps:Array;
				for (i = tweens.length - 1; i > -1; i--) {
					t = tweens[i];
					if (t.isPlugin && t.name == "_MULTIPLE_") { //is a plugin with multiple overwritable properties
						overwriteProps = t.target.overwriteProps;
