 ...
 **                         include< malloc.h, stdio.h, Base.h >                     **
 **__________________________________________________________________________________**
 **************************************************************************************/
...
void vector3D_crossProduct( Vector3D * v1, Vector3D * v2, Vector3D * target )
{
...
void vector3D_slerp( Vector3D * from, Vector3D * to, Vector3D * res, Number t )
{
	* res = * to;
	...
	vector3D_subtract( res, from );

	vector3D_scaleBy( res, t );

	vector3D_add( res, from );
}
...
Vector3D X_AXIS = { 1.0, 0, 0, 1.0 };

Vector3D Y_AXIS = { 0, 1.0, 0, 1.0 };

Vector3D Z_AXIS = { 0, 0, 1.0, 1.0 };
